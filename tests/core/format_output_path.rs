...
mod passing {
    ...
    fn as_is() {
        let final_destination =
            format_output_path("/home/username/Downloads/website.html", Some(""), false);
    ...
    #[test]
    fn level_up() {
        let final_destination = format_output_path("../%title%.html", Some(".Title"), false);
    ...
    fn file_name_extension() {
        let final_destination = format_output_path("%title%.%extension%", Some("Title"), false);
    ...
    fn file_name_extension_mhtml() {
        let final_destination = format_output_path("%title%.%extension%", Some("Title"), true);
    ...
    fn file_name_extension_short() {
        let final_destination = format_output_path("%title%.%ext%", Some("Title"), false);
    ...
    fn file_name_extension_short_mhtml() {
        let final_destination = format_output_path("%title%.%ext%", Some("Title"), true);
